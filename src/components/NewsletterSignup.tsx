  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto grid max-w-[864px] grid-cols-1 items-center gap-7 md:grid-cols-[285px_1fr]">
        <div className="mx-auto grid w-full max-w-[315px] grid-cols-2 gap-3 md:max-w-none">
          {CALENDARS.map((calendar) => (
            <div
              key={calendar.year}
              className="relative aspect-[1054/1492] overflow-hidden rounded-[12px] border-[5px] border-white bg-white shadow-[0_18px_36px_rgba(86,41,8,0.26)]"
            >
              <Image
                src={calendar.href}
                alt={calendar.alt}
                fill
                sizes="(min-width: 768px) 138px, 150px"
        ...
        <div className="text-center text-white md:text-left">
          <h2 className="font-heading text-[34px] font-bold leading-[0.98] tracking-wide text-white md:text-[42px]">
            FREE 2026 & 2027 SCHOOL CALENDARS
          </h2>
          ...
          {submitted ? (
            <div className="mt-6 flex flex-col items-center gap-3 md:items-start">
              <p className="font-body text-[15px] font-extrabold text-white">
                Thanks! Your free calendars are ready.
              </p>
              <div className="flex flex-col gap-3 sm:flex-row">
                {CALENDARS.map((calendar) => (
                  ...
                  >
                    Download {calendar.year} Calendar
                  </a>
                ))}
              </div>
            </div>
